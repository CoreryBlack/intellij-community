    ...
    fn build_file_menu() -> MenuItem {
        MenuItem {
            ...
            children: vec![
                ...
                MenuItem { id: "".to_string(), label: "".into(), item_type: MenuItemType::Separator, icon: None, shortcut: None, enabled: false, visible: true, checked: None, toggle: false, children: vec![], click_action: None },
